...
const Footer = () => {
  return (
    <footer className="bg-neutral-900 text-gray-400 py-8 border-t border-neutral-800">
        ...
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="flex-grow px-4 py-2 rounded-l-md bg-neutral-800 border border-neutral-700 text-white focus:outline-none focus:ring-2 focus:ring-red-600"
            />
            <button
              type="submit"
