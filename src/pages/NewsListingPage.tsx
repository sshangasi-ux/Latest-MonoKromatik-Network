  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      ...
      <main className="flex-grow container mx-auto p-8 text-center">
        <h1 className="text-4xl font-heading font-bold mb-4 uppercase tracking-tight">All News & Articles</h1>
        <p className="text-xl text-muted-foreground mb-8 font-sans">
          Stay updated with the latest news and articles from across Africa.
        </p>
